  ...
  form.parse(zahteva, function(napaka, polja, datoteke){
    strankaIzRacuna(polja.seznamRacunov, function(customer){
      pesmiIzRacuna(polja.seznamRacunov, function(songs){
        ...
        odgovor.render('eslog', { vizualiziraj:true, postavkeRacuna:songs, strankaPodatki:customer})
      })
    })
  })
})
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      ...
      vrniRacune(function(napakar, racuni){
        vrniStranke(function(napakas, stranke){
          if(napaka2||napakar||napakas){
